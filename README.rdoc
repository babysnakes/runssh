...
== Tasks for 0.2.2
* Enable overriding hostname as well as other parameters (e.g. so it's possible
  to create a template for connecting to Ubuntu on EC2)
* Enable tunneling with shortcut (both full -L syntax and a shortcut:
  -L 6000 for -L 6000:localhost:6000)
